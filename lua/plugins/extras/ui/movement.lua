  ...
  },
  {
    ...
    config = function()
      require("smoothcursor").setup({
        ...
        disabled_filetypes = { "graphql", "TelescopePrompt", "NvimTree", "sagafinder", "lazy" }, -- Disable for these file types, ignored if enabled_filetypes is set. e.g., { "TelescopePrompt", "NvimTree" }
