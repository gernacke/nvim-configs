...
local mappings = {
    ...
    z = {
        name = "+ZK",
        a = { ":'<,'>lua vim.lsp.buf.range_code_action()<CR>", "Code Action on Visual Selection" },
        b = { "<Cmd>lua vim.lsp.buf.references()<CR>", "Search ZK Backlinks" },
        l = { "<Cmd>ZkLinks<CR>", "Current Note Links" },
        ...
        t = { "<cmd>ZkTags<cr>", "Select ZK Tags" },
        f = { "<cmd>ZkNotes<cr>", "Search ZK Notes" },
        g = {
