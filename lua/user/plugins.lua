...
function M.setup()
    ...
    local function plugins(use)
        ...
        -- Miscellaneous
        -- TODO find replacer for vim-surround
        ...
        use({
            ...
            -- TODO keybinding search is not working
            -- config = function()
            --     require("user.configs.vim-browser-search")
            -- end
        })
        use({
        ...
        use { "lewis6991/gitsigns.nvim",
            config = function() require("user.configs.gitsigns_config") end
        }
